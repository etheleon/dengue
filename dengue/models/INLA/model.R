...
# inla_forecast_model <- setRefClass(
#   "INLAForecastModel",
#   fields = list(
#     formula = "formula",
#     inla_model = "list",
#     hyperparameters = "list",
#     train_start_time = "character",
#     train_end_time = "character",
#     test_start_time = "character",
#     test_end_time = "character",
#     data = "data.frame",
#     model = "ANY", # This will hold the INLA model after fitting
...
#     #'
#     #' This method parses a config YAML model params, features, random effects
#     #'
...
#       .self$input_s <- yaml_data$input_file
...
#       )
#     },
#     #' Generates model input dataset
#     #'
#     #' This method filters the dataset gathered from upstream feature with the dates specified in the config
#     generate_dataset = function(input_s) {
...
#         ))
#     },
#     #' Fits the INLA model against the specified dataset within the daterange and predict the cases
#     fit = function() {
#       .self$model <- INLA::inla(
#         .self$formula,
